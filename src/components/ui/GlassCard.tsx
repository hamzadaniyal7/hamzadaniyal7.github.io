  ...
  (
    ...
    return (
      <motion.div
        ...
        {...props}
      >
        <div className="pointer-events-none absolute inset-0 rounded-[inherit] bg-gradient-to-br from-white/40 via-transparent to-transparent dark:from-teal-300/[0.04]" />
